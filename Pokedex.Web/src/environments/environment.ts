...
export const environment = {
  ...
  endPoints: {
    ...
    EncounterMethods: 'https://pokeapi.co/api/v2/encounter-method/',
    EncounterConditionValues: 'https://pokeapi.co/api/v2/encounter-condition-value/',
    EvolutionChain: 'https://pokeapi.co/api/v2/evolution-chain/',
    EvolutionTrigger: 'https://pokeapi.co/api/v2/evolution-trigger/',
    Evolution: 'https://pokeapi.co/api/v2/generation/',
    ...
    MoveBatlleStyle: 'https://pokeapi.co/api/v2/move-battle-style/',
